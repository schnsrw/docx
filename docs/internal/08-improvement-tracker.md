...
| ⬜ | 9 | **Duplicate image IDs (`pic:cNvPr id=0`) cause only last image to render** | `openspec/changes/ooxml-roundtrip-fidelity/proposal.md:15` | Parser should key on `r:embed`, not `pic:cNvPr id`. |
